...
<head>
    ...
    <link rel="stylesheet" media="screen, print" href="../registration/css/page-login-alt.css">
</head>
<body>
    ...
    <video poster="../registration/img/backgrounds/clouds.png" id="bgvid" playsinline autoplay muted loop>
        <source src="../registration/media/video/cc.webm" type="video/webm">
        <source src="../registration/media/video/cc.mp4" type="video/mp4">
    </video>
